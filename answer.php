            ...
            <div class="header-content-inner">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 text-center">
                        <h1 class="section-heading">답변하기</h1>
                        <hr class="primary">
                    </div>
                </div>
            </div>
            <div class="container" style="width:60%;">
                <?php echo'<form role="form" class="form-horizontal" action="answerpost.php?num='.$num.'&view='.$view.'" method="post">'?>
                    <div class="form-group" style="text-align: left;">
                        <label class="control-label col-sm-2">답변 내용: </label>
                        <div class="col-sm-10"><textarea name="answer" id="mycontent"class="form-control" rows="10"><?php $result = mysql_query("select * from BOARD where num = '$num'", $connect);
                  $row = mysql_fetch_array($result); echo $row[6]; ?></textarea></div>
                    </div>
                    <button type="submit" class="btn btn-primary btn-xl page-scroll" >제출하기</button>
                </form>
            </div>
        </div>
    </header>
