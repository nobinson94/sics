            ...
            <div class="header-content-inner">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 text-center">
                        <h1 class="section-heading">비밀번호 체크</h1>
                        <hr class="primary">
                    </div>
                </div>
            </div>
            <div class="container" style="width:60%;">
                <?php echo'<form role="form" class="form-inline" action="check_pwd_post.php?num='.$num.'&task='.$task.'" method="post">'?>
                    <div class="form-group" style="text-align: left;">
                        <label class="control-label col-sm-3" style="width:110px; margin-top:7px; font-size:17px;">비밀번호:</label>
                        <div class="col-sm-3">
                            <input name="pass" type="password" maxlength=4 class="form-control" id="pwd">
                        </div>
                    </div>
