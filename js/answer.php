    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
              ...
              <?php $result = mysql_query("select * from BOARD where num = $num", $connect);
                  $row = mysql_fetch_array($result);?>
                  <script>var contents="<?php $row[6] ?>";
                            alert(contents);
            ...
            <div class="container" style="width:60%;">
                <?php echo'<form role="form" class="form-horizontal" action="answerpost.php?num='.$num.'&view='.$view.'" method="post">'?>
                    <div class="form-group" style="text-align: left;">
                        ...
                        <div class="col-sm-10"><textarea name="answer" id="contents"class="form-control" rows="10"></textarea></div>
                    </div>
